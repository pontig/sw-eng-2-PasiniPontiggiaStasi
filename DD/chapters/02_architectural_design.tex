...
URL Parameters:
\begin{itemize}
    \item {\ttfamily{id}}: the id of the tournament that the EDU wants to get the details of
...
URL Parameters:
\begin{itemize}
    \item {\ttfamily{id}}: the id of the battle that the EDU wants to get the list of the codes to evaluate of
\end{itemize}
Response: JSON array
\begin{lstlisting}[language=JavaScript, label={lst:jscode}, basicstyle=\ttfamily]
[
...
URL Parameters:
\begin{itemize}
    \item {\ttfamily{group\_id}}: the id of the group that the EDU wants to evaluate
