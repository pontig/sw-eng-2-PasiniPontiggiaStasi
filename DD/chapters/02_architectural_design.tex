...
\textbf{URL Parameters} :
\begin{itemize}
    \item {\ttfamily{team\_id}} : the team id that the student wants to join
    \item {\ttfamily{student\_id}} : the student id that wants to join the team
\end{itemize}
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Team joined successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have permission to join this team")
    \item {\ttfamily{404}} : error String("Not found - Student or team not found")
    \item {\ttfamily{409}} : error String("Conflict - You are already registered for this team")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("index")
    \item {\ttfamily{400}} : error String("Bad Request - Missing or invalid parameters")
    \item {\ttfamily{409}} : error String("Conflict - An account with the provided email already exists")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("indexSTU") or String("indexEDU")
    \item {\ttfamily{400}} : error String("Bad Request - Missing or invalid parameters")
    \item {\ttfamily{401}} : error String("Unauthorized - Invalid email or password")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Logout successful")
    \item {\ttfamily{401}} : error String("Unauthorized - User not authenticated or session expired")
    \item {\ttfamily{403}} : error String("Forbidden - Insufficient permissions for logout")
    \item {\ttfamily{404}} : error String("Not Found - User not found")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Tournament created successfully - Id: XXX")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to create a tournament")
    \item {\ttfamily{404}} : error String("Not found - Educator not found")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Tournament shared successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to share this tournament")
    \item {\ttfamily{404}} : error String("Not found - Tournament or user not found")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Tournament closed successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to close this tournament")
    \item {\ttfamily{404}} : error String("Not found - Tournament not found")
\end{itemize}
...
\begin{itemize}
    ...
    \item {\ttfamily{gradle\_data}} : Il will be update during implementation, need to understand Gradle better

\end{itemize}
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Battle created successfully - Id: XXX")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to create a battle")
    \item {\ttfamily{404}} : error String("Not found - Educator not found")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Badge created successfully - Id: XXX")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to create a badge")
    \item {\ttfamily{404}} : error String("Not found - Educator not found")
\end{itemize}
...
\textbf{Body Parameters} :
\begin{itemize}
    \item {\ttfamily{team\_id}} : Integer
    \item {\ttfamily{score}} : Integer
\end{itemize}
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Manual evaluation saved successfully but not completed")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to perform manual evaluation")
    \item {\ttfamily{404}} : error String("Not found - Educator, battle or tournament not found")
\end{itemize}

\subsection*{Manual Evaluation Completed}
This endpoint allows the EDU to evaluate perform a manual evaluation on team's code.\\
\textbf{Method} : POST \\
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Manual evaluation completed successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have the necessary rights to perform manual evaluation")
    \item {\ttfamily{404}} : error String("Not found - Educator, battle or tournament not found")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Tournament joined successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have permission to join this tournament")
    \item {\ttfamily{404}} : error String("Not found - Student or tournament not found")
    \item {\ttfamily{409}} : error String("Conflict - You are already registered fpr this tournament")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Battle joined successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have permission to join this battle")
    \item {\ttfamily{404}} : error String("Not found - Student or battle not found")
    \item {\ttfamily{409}} : error String("Conflict - You are already registered for this battle")
\end{itemize}
...
\textbf{Response}:
\begin{itemize}
    \item {\ttfamily{200}} : message String("Student invited successfully")
    \item {\ttfamily{400}} : error String("Bad request - Please check your input parameters")
    \item {\ttfamily{403}} : error String("Forbidden - You do not have permission to invite this student")
    \item {\ttfamily{404}} : error String("Not found - Student or team not found")
    \item {\ttfamily{409}} : error String("Conflict - Student already invited")
\end{itemize}
\newpage
