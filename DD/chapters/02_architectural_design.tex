...
\textbf{Response} :
\begin{itemize}
    \item {\ttfamily{200}} : message String("index.html")
...
\textbf{Response} :
\begin{itemize}
    \item {\ttfamily{200}} : message String("indexSTU.html") or String("indexEDU.html") 
    \item {\ttfamily{400}} : error String("Bad Request - Missing or invalid parameters")
...
\textbf{Method} : POST \\
\textbf{EndPoint} : /tournament/t\_id/share \\
\textbf{URL Parameters}:
\begin{itemize}
    \item {\ttfamily{EDU\_id}} : Integer
...
\textbf{Method} : POST \\
\textbf{EndPoint} : /battles/b\_id/manualEvaluation/completed \\
\textbf{URL Parameters}:
\begin{itemize}
    \item {\ttfamily{EDU\_id}} : Integer
    \item {\ttfamily{tournament\_id}} : Integer
...
\begin{itemize}
    ...
    \item {\ttfamily{404}} : error String("Not found - Educator or battle not found")
\end{itemize}
...
\textbf{Method} : POST \\
\textbf{EndPoint} : /tournament/t\_id/join \\
\textbf{URL Parameters}:
\begin{itemize}
...
\textbf{Method} : POST \\
\textbf{EndPoint} : /battle/b\_id/join \\
\textbf{URL Parameters}:
\begin{itemize}
    \item {\ttfamily{STU\_id}} : Integer
    \item {\ttfamily{tournament\_id}} : Integer   
