...
\begin{table}[H]
    ...
    \begin{tabular}{l l p{12.5cm}}
        ...
        \textbf{Dep1} &  & The system will integrate an external API in order to compile the code written by students\\
        \textbf{Dep1} &  & The system will integrate an external API in order create repository for each battle\\
        \hline
    \end{tabular}
