...
\begin{center}
    ...
    \begin{tabular}{| m{2cm} | m{10cm}|}
        \hline
        Name                  & View a battle                                                           \\ \hline
        ID                    & UC20                                                                    \\ \hline
        Actors                & EDU or STU                                                              \\ \hline
        Entry \par conditions & The actor is logged \textbf{and} it is on the page of a tournament      \\ \hline
        Event \par flow       & \begin{enumerate}
                                    \item The actor selects a battle
                                    \item The system shows the battle page
                                \end{enumerate}                                   \\ \hline
        Exit \par conditions  & The actor can see the battle page with all the infos regarding a battle \\ \hline
        Exceptions            & \textit{None}                                                           \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \begin{longtable}[H]{|c|l|}
        ...
        UC19              & R21, R23                         \\ \hline
        UC20              & R5, R6, R7, R18, R21, R25,R26    \\ \hline
    \end{longtable}
\end{center}
