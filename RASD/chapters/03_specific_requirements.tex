...
{\color{red} Non empty field, wrong format and transaction atomicity da mettere da qualche parte come assunzione}
...
\begin{center}
    ...
    \begin{tabular}{| m{2cm} | m{10cm}|}
        ...
        Exceptions            & \textit{None}                                                                                                    \\ \hline
        Notes                 & Only one students per team receive the github repository  link via mail \n The correct functioning are assumed, so, by the side of the platform, nothing could go wrong                     \\ \hline
    \end{tabular}
\end{center}
