        ...
        * */
        ...
        return args -> {
           ...
           battles.add(new Battle("Opening battle",            sdf.parse("2024-02-10"), sdf.parse("2024-02-15"), sdf.parse("2024-02-20"), "Java", false, 1, 2,     educators.get(1-1), tournaments.get(1-1), false));
            ...
            teams.getLast().addStudent(students.get(18-5));
            log.info("added a player to a team");
            teams.add(new Team("Team 03", battles.get(1-1)));
            teams.getLast().addStudent(students.get(17-5));
            log.info("added a player to a team");
            teams.add(new Team("Team 04", battles.get(1-1)));
            teams.getLast().addStudent(students.get(16-5));
            log.info("added a player to a team");
            ...
            teams.getLast().addStudent(students.get(18-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(13-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(12-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(11-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(10-5));
            log.info("added a player to a team");
            teams.add(new Team("Team 07", battles.get(2-1)));
            teams.getLast().addStudent(students.get(9-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(8-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(7-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(6-5));
            log.info("added a player to a team");
            ...
            teams.getLast().addStudent(students.get(13-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(14-5));
            log.info("added a player to a team");
            teams.add(new Team("Team 11", battles.get(3-1)));
            teams.getLast().addStudent(students.get(15-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(16-5));
            log.info("added a player to a team");
            ...
            teams.getLast().addStudent(students.get(19-5));
            log.info("added a player to a team");
            teams.getLast().addStudent(students.get(5-5));
            log.info("added a player to a team");
