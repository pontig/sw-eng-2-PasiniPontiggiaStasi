...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
        ...
        Final revision before the delivery & 4h            \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
        \hline
        \textbf{Topic}                           & \textbf{Time} \\ \hline
        POST endpoints                           & 20h           \\ \hline
        External APIs (GitHub and Gmail)         & 20h           \\ \hline
        Setting up the test of the uploaded code & 30h           \\ \hline
        Frontend requests refining               & 10h           \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
        ...
        \textbf{Topic}          & \textbf{Time} \\ \hline
        Frontend                & 35h           \\ \hline
        http requests exchange  & 16h           \\ \hline
        Writing of the document & 6h            \\ \hline
    \end{tabular}
